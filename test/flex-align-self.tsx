...
test('row - align text to center', t => {
	const output = renderToString(<Box height={3}>
...
test('column - align text to center', t => {
	const output = renderToString(<Box flexDirection='column' width={10}>
		<Box alignSelf='center'>
			<Text>Test</Text>
		</Box>
	</Box>);
...
test('column - align self stretch', t => {
	const output = renderToString(<Box flexDirection='column' width={7}>
