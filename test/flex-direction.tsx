...
test('direction row', t => {
	const output = renderToString(<Box flexDirection='row'>
		<Text>A</Text>
		<Text>B</Text>
	</Box>);
...
test('direction row reverse', t => {
	const output = renderToString(<Box flexDirection='row-reverse' width={4}>
		<Text>A</Text>
		<Text>B</Text>
	</Box>);
...
test('direction column reverse', t => {
	const output = renderToString(<Box flexDirection='column-reverse' height={4}>
		<Text>A</Text>
		<Text>B</Text>
	</Box>);
...
test('direction row - concurrent', async t => {
	const output = await renderToStringAsync(<Box flexDirection='row'>
		<Text>A</Text>
		<Text>B</Text>
	</Box>);
